...
<form action="{{ url("/settings/customization") }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="setting-list">
        ...
        <div homepage-control id="homepage-control" class="grid half gap-xl {{setting('app-public') ? '' : 'items-center'}}">
            <div>
            ...
            <div>
                ...
                <label for="setting-app-homepage-type-user" class="text-dark">{{ trans('settings.app_homepage_user') }}</label>
                @endif
                <select name="setting-app-homepage-type-user" id="setting-app-homepage-type">
                    <option @if(setting('app-homepage-type-user')==='default' ) selected @endif value="default">{{ trans('common.default') }}</option>
                    <option @if(setting('app-homepage-type-user')==='books' ) selected @endif value="books">{{ trans('entities.books') }}</option>
                    <option @if(setting('app-homepage-type-user')==='bookshelves' ) selected @endif value="bookshelves">{{ trans('entities.shelves') }}</option>
                    <option @if(setting('app-homepage-type-user')==='page' ) selected @endif value="page">{{ trans('entities.pages_specific') }}</option>
                </select>
                <div page-picker-container-user style="display: none;" class="mt-m">
                    @include('settings.parts.page-picker', ['name' => 'setting-app-homepage-user', 'placeholder' => trans('settings.app_homepage_select'), 'value' => setting('app-homepage-user')])
                </div>

                @if(setting('app-public'))
                <label for="setting-app-homepage-type" class="text-dark pt-s">{{ trans('settings.app_homepage_public') }}</label>
                <select name="setting-app-homepage-type-public" id="setting-app-homepage-type-public">
                    <option @if(setting('app-homepage-type-public')==='default' ) selected @endif value="default">{{ trans('common.default') }}</option>
                    <option @if(setting('app-homepage-type-public')==='books' ) selected @endif value="books">{{ trans('entities.books') }}</option>
                    <option @if(setting('app-homepage-type-public')==='bookshelves' ) selected @endif value="bookshelves">{{ trans('entities.shelves') }}</option>
                    <option @if(setting('app-homepage-type-public')==='page' ) selected @endif value="page">{{ trans('entities.pages_specific') }}</option>
                </select>

                    <div page-picker-container-public style="display: none;" class="mt-m">
                        @include('settings.parts.page-picker', ['name' => 'setting-app-homepage-public', 'placeholder' => trans('settings.app_homepage_select'), 'value' => setting('app-homepage-public')])
                    </div>
                @endif
            </div>
        </div>
        ...
        <div>
            ...
            <div class="mt-m">
                <textarea component="code-textarea" option:code-textarea:mode="html" name="setting-app-custom-head" id="setting-app-custom-head" class="simple-code-input">{{ setting('app-custom-head', '') }}</textarea>
            </div>
