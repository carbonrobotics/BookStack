...
@section('card')
    ...
    <form action="{{ url("/settings/customization") }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="setting-list">
            ...
            <div homepage-control id="homepage-control" class="grid half gap-xl items-start">
                <div>
                    <label for="setting-app-homepage-type" class="setting-list-label">{{ trans('settings.app_homepage') }}</label>
                    <p class="small">{{ trans('settings.app_homepage_desc') }}</p>
                </div>
                <div>
                    <label for="setting-app-homepage-type" class="text-dark pt-s">{{ trans('settings.app_homepage') }}</label>
                    ...
                    <label for="setting-app-homepage-type-public" class="text-dark pt-s">{{ trans('settings.app_homepage_public') }}</label>
